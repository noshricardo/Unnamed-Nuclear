...
public class CentrifugeMenu extends AbstractContainerMenu {
    ...
    public CentrifugeMenu(int containerId, Inventory playerInventory, FriendlyByteBuf extraData) {
        this(containerId, playerInventory, (CentrifugeBlockEntity) playerInventory.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public CentrifugeMenu(int containerId, Inventory playerInventory, CentrifugeBlockEntity blockEntity, ContainerData data) {
        super(Registration.CENTRIFUGE_MENU.get(), containerId);
    ...
    public boolean stillValid(Player player) {
        return stillValid(access, player, Registration.CENTRIFUGE.get());
    }
