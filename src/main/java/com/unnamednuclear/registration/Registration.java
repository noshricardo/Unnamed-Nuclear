...
public class Registration {
    ...
    public static final DeferredHolder<FluidType, FluidType> SODIUM_TYPE = FLUID_TYPES.register("liquid_sodium", () -> new FluidType(FluidType.Properties.create().density(927).viscosity(700).temperature(400)));
    public static final DeferredHolder<FluidType, FluidType> HOT_SODIUM_TYPE = FLUID_TYPES.register("hot_liquid_sodium", () -> new FluidType(FluidType.Properties.create().density(900).viscosity(600).temperature(800)));

    public static final DeferredHolder<Fluid, Fluid> HF = FLUIDS.register("hydrofluoric_acid", () -> new net.neoforged.neoforge.fluids.BaseFlowingFluid.Source(new net.neoforged.neoforge.fluids.BaseFlowingFluid.Properties(HF_TYPE, Registration.HF, Registration.HF_FLOWING).bucket(Registration.HF_BUCKET)));
    public static final DeferredHolder<Fluid, Fluid> HF_FLOWING = FLUIDS.register("hydrofluoric_acid_flowing", () -> new net.neoforged.neoforge.fluids.BaseFlowingFluid.Flowing(new net.neoforged.neoforge.fluids.BaseFlowingFluid.Properties(HF_TYPE, Registration.HF, Registration.HF_FLOWING).bucket(Registration.HF_BUCKET)));
    public static final DeferredItem<Item> HF_BUCKET = ITEMS.register("hydrofluoric_acid_bucket", () -> new net.minecraft.world.item.BucketItem(Registration.HF.get(), new Item.Properties().craftRemainder(net.minecraft.world.item.Items.BUCKET).stacksTo(1)));

    public static final DeferredHolder<Fluid, Fluid> F2 = FLUIDS.register("fluorine_gas", () -> new net.neoforged.neoforge.fluids.BaseFlowingFluid.Source(new net.neoforged.neoforge.fluids.BaseFlowingFluid.Properties(F2_TYPE, Registration.F2, Registration.F2_FLOWING).bucket(Registration.F2_BUCKET)));
    public static final DeferredHolder<Fluid, Fluid> F2_FLOWING = FLUIDS.register("fluorine_gas_flowing", () -> new net.neoforged.neoforge.fluids.BaseFlowingFluid.Flowing(new net.neoforged.neoforge.fluids.BaseFlowingFluid.Properties(F2_TYPE, Registration.F2, Registration.F2_FLOWING).bucket(Registration.F2_BUCKET)));
    public static final DeferredItem<Item> F2_BUCKET = ITEMS.register("fluorine_gas_bucket", () -> new net.minecraft.world.item.BucketItem(Registration.F2.get(), new Item.Properties().craftRemainder(net.minecraft.world.item.Items.BUCKET).stacksTo(1)));

    public static final DeferredHolder<Fluid, Fluid> UF6 = FLUIDS.register("uranium_hexafluoride", () -> new net.neoforged.neoforge.fluids.BaseFlowingFluid.Source(new net.neoforged.neoforge.fluids.BaseFlowingFluid.Properties(UF6_TYPE, Registration.UF6, Registration.UF6_FLOWING).bucket(Registration.UF6_BUCKET)));
    public static final DeferredHolder<Fluid, Fluid> UF6_FLOWING = FLUIDS.register("uranium_hexafluoride_flowing", () -> new net.neoforged.neoforge.fluids.BaseFlowingFluid.Flowing(new net.neoforged.neoforge.fluids.BaseFlowingFluid.Properties(UF6_TYPE, Registration.UF6, Registration.UF6_FLOWING).bucket(Registration.UF6_BUCKET)));
    public static final DeferredItem<Item> UF6_BUCKET = ITEMS.register("uranium_hexafluoride_bucket", () -> new net.minecraft.world.item.BucketItem(Registration.UF6.get(), new Item.Properties().craftRemainder(net.minecraft.world.item.Items.BUCKET).stacksTo(1)));

    public static final DeferredHolder<Fluid, Fluid> HNO3 = FLUIDS.register("nitric_acid", () -> new net.neoforged.neoforge.fluids.BaseFlowingFluid.Source(new net.neoforged.neoforge.fluids.BaseFlowingFluid.Properties(HNO3_TYPE, Registration.HNO3, Registration.HNO3_FLOWING).bucket(Registration.HNO3_BUCKET)));
    public static final DeferredHolder<Fluid, Fluid> HNO3_FLOWING = FLUIDS.register("nitric_acid_flowing", () -> new net.neoforged.neoforge.fluids.BaseFlowingFluid.Flowing(new net.neoforged.neoforge.fluids.BaseFlowingFluid.Properties(HNO3_TYPE, Registration.HNO3, Registration.HNO3_FLOWING).bucket(Registration.HNO3_BUCKET)));
    public static final DeferredItem<Item> HNO3_BUCKET = ITEMS.register("nitric_acid_bucket", () -> new net.minecraft.world.item.BucketItem(Registration.HNO3.get(), new Item.Properties().craftRemainder(net.minecraft.world.item.Items.BUCKET).stacksTo(1)));

    public static final DeferredHolder<Fluid, Fluid> TBP = FLUIDS.register("tbp_kerosene", () -> new net.neoforged.neoforge.fluids.BaseFlowingFluid.Source(new net.neoforged.neoforge.fluids.BaseFlowingFluid.Properties(TBP_TYPE, Registration.TBP, Registration.TBP_FLOWING).bucket(Registration.TBP_BUCKET)));
    public static final DeferredHolder<Fluid, Fluid> TBP_FLOWING = FLUIDS.register("tbp_kerosene_flowing", () -> new net.neoforged.neoforge.fluids.BaseFlowingFluid.Flowing(new net.neoforged.neoforge.fluids.BaseFlowingFluid.Properties(TBP_TYPE, Registration.TBP, Registration.TBP_FLOWING).bucket(Registration.TBP_BUCKET)));
    public static final DeferredItem<Item> TBP_BUCKET = ITEMS.register("tbp_kerosene_bucket", () -> new net.minecraft.world.item.BucketItem(Registration.TBP.get(), new Item.Properties().craftRemainder(net.minecraft.world.item.Items.BUCKET).stacksTo(1)));

    public static final DeferredHolder<Fluid, Fluid> SODIUM = FLUIDS.register("liquid_sodium", () -> new net.neoforged.neoforge.fluids.BaseFlowingFluid.Source(new net.neoforged.neoforge.fluids.BaseFlowingFluid.Properties(SODIUM_TYPE, Registration.SODIUM, Registration.SODIUM_FLOWING).bucket(Registration.SODIUM_BUCKET)));
    public static final DeferredHolder<Fluid, Fluid> SODIUM_FLOWING = FLUIDS.register("liquid_sodium_flowing", () -> new net.neoforged.neoforge.fluids.BaseFlowingFluid.Flowing(new net.neoforged.neoforge.fluids.BaseFlowingFluid.Properties(SODIUM_TYPE, Registration.SODIUM, Registration.SODIUM_FLOWING).bucket(Registration.SODIUM_BUCKET)));
    public static final DeferredItem<Item> SODIUM_BUCKET = ITEMS.register("liquid_sodium_bucket", () -> new net.minecraft.world.item.BucketItem(Registration.SODIUM.get(), new Item.Properties().craftRemainder(net.minecraft.world.item.Items.BUCKET).stacksTo(1)));

    public static final DeferredHolder<Fluid, Fluid> HOT_SODIUM = FLUIDS.register("hot_liquid_sodium", () -> new net.neoforged.neoforge.fluids.BaseFlowingFluid.Source(new net.neoforged.neoforge.fluids.BaseFlowingFluid.Properties(HOT_SODIUM_TYPE, Registration.HOT_SODIUM, Registration.HOT_SODIUM_FLOWING).bucket(Registration.HOT_SODIUM_BUCKET)));
    public static final DeferredHolder<Fluid, Fluid> HOT_SODIUM_FLOWING = FLUIDS.register("hot_liquid_sodium_flowing", () -> new net.neoforged.neoforge.fluids.BaseFlowingFluid.Flowing(new net.neoforged.neoforge.fluids.BaseFlowingFluid.Properties(HOT_SODIUM_TYPE, Registration.HOT_SODIUM, Registration.HOT_SODIUM_FLOWING).bucket(Registration.HOT_SODIUM_BUCKET)));
    public static final DeferredItem<Item> HOT_SODIUM_BUCKET = ITEMS.register("hot_liquid_sodium_bucket", () -> new net.minecraft.world.item.BucketItem(Registration.HOT_SODIUM.get(), new Item.Properties().craftRemainder(net.minecraft.world.item.Items.BUCKET).stacksTo(1)));
    ...
    public static final DeferredHolder<Fluid, Fluid> STEAM = FLUIDS.register("steam", () -> new net.neoforged.neoforge.fluids.BaseFlowingFluid.Source(new net.neoforged.neoforge.fluids.BaseFlowingFluid.Properties(STEAM_TYPE, Registration.STEAM, Registration.STEAM_FLOWING).bucket(Registration.STEAM_BUCKET)));
    public static final DeferredHolder<Fluid, Fluid> STEAM_FLOWING = FLUIDS.register("steam_flowing", () -> new net.neoforged.neoforge.fluids.BaseFlowingFluid.Flowing(new net.neoforged.neoforge.fluids.BaseFlowingFluid.Properties(STEAM_TYPE, Registration.STEAM, Registration.STEAM_FLOWING).bucket(Registration.STEAM_BUCKET)));
    public static final DeferredItem<Item> STEAM_BUCKET = ITEMS.register("steam_bucket", () -> new net.minecraft.world.item.BucketItem(Registration.STEAM.get(), new Item.Properties().craftRemainder(net.minecraft.world.item.Items.BUCKET).stacksTo(1)));
    ...
    public static final DeferredItem<Item> DEBUG_ITEM = ITEMS.register("debug_item", () -> new com.unnamednuclear.item.DebugItem(new Item.Properties().stacksTo(1)));
